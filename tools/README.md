...
| **`update-sing-box-core.ps1`** | **【核心同步】** | 官方 Go 核心发新版时，一键从 GitHub Releases 下载最新 `libbox.aar`（未变秒级跳过，并自动联动规范体检） | `.\tools\update-sing-box-core.ps1` |
| **`rebase-to-latest-clients-tag.ps1`** | **【代码同步】** | 官方 Android 客户端发新版时，自动将本仓库变基至官方最新主线（自带版本备份与安全回滚） | `.\tools\rebase-to-latest-clients-tag.ps1` |
